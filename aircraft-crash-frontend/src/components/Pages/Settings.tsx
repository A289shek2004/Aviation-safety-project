...
const Settings: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'users', label: 'User Preferences', icon: User }
  ];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage system preferences and configurations</p>
      </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value="AirEasy - Aviation Intelligence System"
                  ...
                  <div>
                    ...
                    <textarea
                      rows={3}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="AI-powered aviation safety analysis and prediction system"
                    />
                  </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        { label: 'High-risk flight alerts', description: 'Immediate notifications for high-risk predictions' },
                        { label: 'Daily safety reports', description: 'Summary of daily safety metrics' },
                        { label: 'System alerts', description: 'Technical issues and system status' },
                        { label: 'User activity', description: 'New user registrations and role changes' }
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        { label: 'Emergency alerts', description: 'Critical safety incidents' },
                        { label: 'Data processing complete', description: 'When data analysis is finished' },
                        { label: 'Weekly summaries', description: 'Weekly safety performance reports' }
                      ].map((notification, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            <p className="font-medium text-gray-900">{notification.label}</p>
            ...
            {activeTab === 'security' && (
              <div className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">API Security</h4>
                    <div className="space-y-3">
              ...
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Incident Data (months)</label>
                        <input
                          type="number"
                          value="36"
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            {activeTab === 'users' && (
              <div className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">User Registration</h4>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <p className="font-medium text-gray-900">Allow Self Registration</p>
                          <p className="text-sm text-gray-600">Users can create accounts without invitation</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input type="checkbox" className="sr-only peer" />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
